...
# /catchon — Load and Resume from Archive
...
1. List all `.md` files in `.claude/alley-oop/archive/`, sorted newest first.
   If the archive is empty or doesn't exist, tell the user and suggest using `/passin` in future sessions.
...
4. Once the user picks, read that full file and follow the /catch flow:
